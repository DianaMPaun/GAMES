...
""")
st.sidebar.image("https://github.com/DianaMPaun/GAMES/blob/main/Rock-Paper-Scissors/rock_paper_scissors.png")
...
if st.button("Play"):
    ...
    if computer == you:
        st.title("It's a tie!")
        st.image("https://github.com/DianaMPaun/GAMES/blob/main/Rock-Paper-Scissors/confused.png")
        ...
        st.image("https://github.com/DianaMPaun/GAMES/blob/main/Rock-Paper-Scissors/nooo.png")
    else:
        st.title("You win!")
        st.image("https://github.com/DianaMPaun/GAMES/blob/main/Rock-Paper-Scissors/thumbs_up.png")
